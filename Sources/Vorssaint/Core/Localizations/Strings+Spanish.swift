...
extension Strings {
    static let es = Strings(
        ...
        smoothScrollCaption: "Convierte cada paso de la rueda del ratón en un deslizamiento largo y suave, con distancia, velocidad y duración ajustables. El trackpad no cambia.",
