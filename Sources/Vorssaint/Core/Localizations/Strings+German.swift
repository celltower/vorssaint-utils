...
extension Strings {
    static let de = Strings(
        ...
        smoothScrollCaption: "Verwandelt jeden Rastschritt des Mausrads in ein langes, sanftes Auslaufen — mit einstellbarer Distanz, Geschwindigkeit und Dauer. Das Trackpad bleibt unverändert.",
